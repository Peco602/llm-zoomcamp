...
```
The version of Mage is v0.9.72.
```
...
Let's read the documents. We will use the same code we used for parsing FAQ: [parse-faq-llm.ipynb](parse-faq-llm.ipynb)
...
```
The FAQ processed document is 1.
```
...
```
We have 86 documents (chunks) in the output.
```
...
```
The index name is documents_20240819_1425.
Tha last document id is 6fc3236a.
```
